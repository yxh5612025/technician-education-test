package com.zzhy.common.core.controller;
...
import com.zzhy.common.core.page.PageDomain;
import com.zzhy.common.core.page.TableDataInfo;
import com.zzhy.common.core.page.TableSupport;
import com.zzhy.common.utils.DateUtils;
import com.zzhy.common.utils.PageUtils;
import com.zzhy.common.utils.SecurityUtils;
import com.zzhy.common.utils.StringUtils;
import com.zzhy.common.utils.sql.SqlUtil;
...
public class BaseController
{
     ...
     */
    @SuppressWarnings({ "rawtypes", "unchecked" })
    protected ApiTableDataInfo getApiDataTable(List<?> list)
    {
        ApiTableDataInfo rspData = new ApiTableDataInfo();
        rspData.setRows(list);
        rspData.setTotal(new PageInfo(list).getTotal());
        return rspData;
    }
