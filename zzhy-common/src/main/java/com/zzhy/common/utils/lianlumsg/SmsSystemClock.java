 ...
 * @author lry
 */
public class SmsSystemClock {
    private final long period;
    private final AtomicLong now;
    ExecutorService executor = Executors.newSingleThreadExecutor();

    private SmsSystemClock(long period) {
        this.period = period;
    ...
    private static class InstanceHolder {
        public static final SmsSystemClock INSTANCE = new SmsSystemClock(1);
    }

    private static SmsSystemClock instance() {
