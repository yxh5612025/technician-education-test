package com.zzhy.framework.web.exception;

import com.zzhy.common.constant.HttpStatus;
import com.zzhy.common.core.domain.AjaxResult;
import com.zzhy.common.exception.DemoModeException;
...
public class GlobalExceptionHandler
{
    ...
    public AjaxResult handleWebException(WebException e, HttpServletRequest request)
    {
        log.error(e.getMessage(), e);
