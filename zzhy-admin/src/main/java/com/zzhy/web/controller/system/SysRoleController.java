...
import com.zzhy.framework.web.service.SysPermissionService;
import com.zzhy.framework.web.service.TokenService;
...
public class SysRoleController extends BaseController
{
    ...
    {
        startPage();
        role.setEnterFlag(0);//0-列表入口，1-用户新增编辑接口
